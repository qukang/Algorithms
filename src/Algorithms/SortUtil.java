...
public class SortUtil {
    ...
    public static void main(String[] args){
        ...
        /*Algorithms.Stopwatch timer1 = new Algorithms.Stopwatch();
        Algorithms.SortUtil.selectionSort(a);
        double t1 = timer1.elapsedTime();
        Algorithms.Stopwatch timer2 = new Algorithms.Stopwatch();
        Algorithms.SortUtil.insertionSort(b);
